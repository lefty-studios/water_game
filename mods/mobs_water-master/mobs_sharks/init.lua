...
-- large
	if ENABLE_SHARK_LARGE then
		mobs:register_mob("mobs_sharks:shark_lg", {
			...
			specific_attack = {"player", "mobs_nssm:crab","mobs_fish:tropical","mobs_nssm:octopus","mobs_nssm:kraken","mobs_m:whale"},
			damage = 10,
			reach = 3,
			hp_min = 20,
			hp_max = 25,
...
-- medium
	if ENABLE_SHARK_MEDIUM then
		mobs:register_mob("mobs_sharks:shark_md", {
			...
			attack_animals = true,
			attack_monsters = true,
			specific_attack = {"player", "mobs_fish:tropical","mobs_nssm:crab","mobs_nssm:octopus","mobs_nssm:kraken","mobs_sharks:shark_sm"},
			damage = 8,
			reach = 2,
			hp_min = 15,
			hp_max = 20,
...
-- small
	if ENABLE_SHARK_SMALL then
		mobs:register_mob("mobs_sharks:shark_sm", {
			...
			reach = 1,
			attack_monsters = true,
			specific_attack = {"player", "mobs_fish:tropical","mobs_nssm:crab","mobs_nssm:octopus","mobs_nssm:kraken"},
			hp_min = 10,
			hp_max = 15,
			armor = 100,
